<template>
  <div class="panel" style="height:100%">
    ...
    <div class="table-wrap">
      <el-table :data="logs" size="small" max-height="400" stripe>
        <el-table-column
          v-for="col in LOG_COLUMNS"
          :key="col.prop"
          :prop="col.prop"
          :label="col.label"
          :width="col.width"
...
import { LOG_COLUMNS, levelTagType, useAnalysisResult } from '../composables/useAnalysisResult'
const { totalLogs, logs } = useAnalysisResult()
</script>
